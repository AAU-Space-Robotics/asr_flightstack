...
public:
    ...
    void GyroScopeIndicator(ImDrawList* draw_list, ImVec2 center, const EulerAngles& orientation, bool theme, float scale);
    void Compas(ImDrawList* draw_list, ImVec2 center, const EulerAngles& orientation, bool theme, float scale);
