...
def generate_launch_description():
    gunnhild_pkg_share = FindPackageShare('gunnhild')

    params_path = PathJoinSubstitution([gunnhild_pkg_share, 'config', 'uav', 'gunnhild_params.yaml'])
    comms_path  = PathJoinSubstitution([gunnhild_pkg_share, 'config', 'comms', 'gunnhild_comms.yaml'])
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                PathJoinSubstitution([gunnhild_pkg_share, 'launch', 'uav', 'gunnhild_perception.launch.py'])
            ),
            launch_arguments={
